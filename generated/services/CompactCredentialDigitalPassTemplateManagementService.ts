...
export class CompactCredentialDigitalPassTemplateManagementService {
     ...
     * @throws ApiError
     */
    public static createCcApplePassTemplate(
        formData: {
            template: Blob;
            /**
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/v2/credentials/compact/digitalpass/apple/templates',
            formData: formData,
     ...
     * @throws ApiError
     */
    public static listCcApplePassTemplates(
        limit: number = 100,
        cursor?: string,
    ): CancelablePromise<{
        nextCursor?: string;
     ...
     * @throws ApiError
     */
    public static updateCcApplePassTemplate(
        id: string,
        id: string,
        formData: {
            template: Blob;
        ...
        return __request(OpenAPI, {
            method: 'PUT',
            url: '/v2/credentials/compact/digitalpass/apple/templates/{id}',
            path: {
                'id': id,
                'id': id,
            },
     ...
     * @throws ApiError
     */
    public static retrieveCcApplePassTemplate(
        id: string,
        id: string,
    ): CancelablePromise<{
        id?: string;
     ...
     * @throws ApiError
     */
    public static deleteCcApplePassTemplate(
        id: string,
        id: string,
     ...
     * {
         * "loyaltyClass": {
             ...
             * "loyaltyObject": {
                 ...
                 * @throws ApiError
                 */
                public static createCcGooglePassTemplate(
                    formData: {
                        template: Blob;
                        /**
                         * Name of the template
                    ...
                    return __request(OpenAPI, {
                        method: 'POST',
                        url: '/v2/credentials/compact/digitalpass/google/templates',
                        formData: formData,
                        mediaType: 'multipart/form-data',
                        errors: {
                            400: `Bad Request`,
                 ...
                 * @throws ApiError
                 */
                public static getCcGooglePassTemplates(
                    limit: number = 100,
                    cursor?: string,
                ): CancelablePromise<{
                    nextCursor?: string;
                 ...
                 * @throws ApiError
                 */
                public static updateCcGooglePassTemplate(
                    id: string,
                    id: string,
                    formData: {
                        template: Blob;
                    ...
                    return __request(OpenAPI, {
                        method: 'PUT',
                        url: '/v2/credentials/compact/digitalpass/google/templates/{id}',
                        path: {
                            'id': id,
                            'id': id,
                        },
                 ...
                 * @throws ApiError
                 */
                public static retrieveCcGooglePassTemplate(
                    id: string,
                    id: string,
                ): CancelablePromise<{
                    id?: string;
                 ...
                 * @throws ApiError
                 */
                public static deleteCcGooglePassTemplate(
                    id: string,
                    id: string,
                ): CancelablePromise<void> {
                    return __request(OpenAPI, {
