...
export class CompactCredentialPdfGenerationService {
     ...
     * @returns any PDF containing the CWT encoded credential
     * @throws ApiError
     */
    public static genCompactPdf(
        requestBody: {
            /**
        ...
        return __request(OpenAPI, {
            method: 'POST',
            url: '/v2/credentials/compact/pdf',
            body: requestBody,
